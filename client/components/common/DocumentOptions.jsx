...
class DocumentOptions extends React.Component {
  ...
  /**
   * 
   * set state documentView to open
   * 
   * @memberof DocumentOptions
   */
  openDocumentView() {
  ...
  /**
   * 
   * set state documentView to close
   * 
   * @memberof DocumentOptions
   */
  closeDocumentView() {
  ...
  /**
   * 
   * toggle set state for delete dialog open/close
   * 
   * @memberof DocumentOptions
   */
  toggleDeleteDialog() {
  ...
  /**
   * 
   * set state openEditDialog to open
   * 
   * @memberof DocumentOptions
   */
  openEditDialog() {
  ...
  /**
   * set state openEditDialog to close
   * 
   * 
   * @memberof DocumentOptions
   */
